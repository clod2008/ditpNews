...
import { bbm25LogoPrimary, faena, logosFood, thai360, thaiFestVideoHero } from '../assets';
          ...
          <Container className='h-100 d-flex align-items-center' >
            <Col className={`${styles.heroVideoBannerText} `} >
              ...
              <p><span>Buenos Aires Business Matching 2025</span> <br />
                Un evento exclusivo organizado por DITP (Departamento de Promoción de Comercio Internacional, Ministerio de Comercio de Tailandia),<br/>con el apoyo de la Embajada Real de Tailandia y Thai Select.</p>
