                    ...
                    {Array.from(data.contact).map((item, id) =>(
                        <Accordion key={id}>
                            <Accordion.Item eventKey={item.name}>
                                <Accordion.Header className={styles.accordionHeader}>{item.name}</Accordion.Header>
                                <Accordion.Body className={styles.accordionBody}>
                                    <LangSelector enText={`Address: ${item.address}`} esText={`Dirección: ${item.address}`}/>
                                    <br/>
                                    {item.phone ?(
                                    <>
                                        <LangSelector enText='Phones:' esText='Teléfonos:' />
                                        <ul>
                                            {
